...
def getPersonGroups(): # https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395246
    # Request headers
    headers = {
    ...
    # route to the face api
    path_to_face_list_api = '/face/v1.0/persongroups' # + '/faceListId' # in case you want to get a specific list
...
def identify():
    ...
    # these parameters tell the api I want to detect a face and a smile
    faceIds = [
            # "5d6d6dd6-fa98-4872-bf07-d95c1bf8b58e"
            '3a2f741b-721c-475c-af68-172d19608481'
        ]
    params = {
...
# detect('/Users/pshalev/Downloads/trump-twitter.jpg') # '/Users/pshalev/Documents/Avatar.jpg'
# detect('/Users/pshalev/Downloads/The_Avengers_Assembled.jpg')
# identify()
...
# getPersonGroups()
# addPersonGroup("meetup_persons_list" ,"meetup_persons_list", "The data used in the meetup for persons group.")
